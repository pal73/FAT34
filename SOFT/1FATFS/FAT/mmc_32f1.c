...
#define	MMC_CD		!(GPIOA_IDR & _BV(0))	/* Card detect (yes:true, no:false, default:true) */
...
#define	SPIxENABLE() {\
	...
	__gpio_conf_bit(GPIOC, 2, OUT_PP);						/* PC2: MMC_CS */\
	...
	GPIOA_BSRR = _BV(0); __gpio_conf_bit(GPIOA, 0, IN_PUL);	/* PC4: MMC_CD with pull-up */\
