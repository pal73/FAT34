...
U16 const _NFILE        = 16;
U16 const _DEF_DRIVE    = 4;
U32 const _CPU_CLK      = 100000000;



 

#line 150 "File_Config.c"
 DEVCONF const FlashDev [1] = {0,0};
 U16 const _FlashNumSect = 0;
 U32 const _BlockFREE    = 0x00000000;
 U32 const _BASE_ADR     = 0x80000000;
...
#line 225 "File_Config.c"
  
 U32 mc_cache[128 * (8 + 2)] ;
 U16 const _MC_CSIZE = 8;
#line 313 "File_Config.c"
